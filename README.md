...
├─ *_test.py             45 套测试共 505 用例（系统 Python 3.8+ 含 tkinter 全绿；managed Python 缺 tkinter 时 resident_test 收集失败）；pytest 与零依赖 runner 双通道
...
python -m pytest -q                        # 全量 505 例 (45 套; 系统 Python 3.8+ 含 tkinter)
...
> **环境差异说明**：系统 Python 3.8+ 含 tkinter 时跑 **45 套 / 505 例 / 失败 0**；
